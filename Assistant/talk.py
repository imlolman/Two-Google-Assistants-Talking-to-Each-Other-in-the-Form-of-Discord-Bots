...
@click.option('--query', '-v',
              required=True,
              help='Give a Query for Google Assistant.')
@click.option('--grpc-deadline', default=DEFAULT_GRPC_DEADLINE,
              metavar='<grpc deadline>', show_default=True,
              help='gRPC deadline in seconds')
def main(api_endpoint, credentials,
         device_model_id, device_id, query , lang, display, verbose,
    ...
    with SampleTextAssistant(lang, device_model_id, device_id, display,
        ...
        if response_text:
            ...
            data = {'string': response_text}
        else:
            data = {'string': 'Reply Please...'}
        # save the data
